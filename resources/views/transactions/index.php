                    ...
                    <table class="table table-responsive table-info shadow text-center">
                        ...
                        <tbody id="tbody">
                            <?php foreach ($data->transactions as $transaction) : ?>
                                <tr>
                                    <th class="<?= ($transaction->total) >= 1000 ? "bg-warning" : " " ?>" scope="row"><?= $counter++ ?></th>
                                    ...
                                    <td class="<?= ($transaction->total) >= 1000 ? "bg-warning" : " " ?>"><a href="/transaction?id=<?= $transaction->id ?>" class="btn btn-primary">Show Details</a></td>
